...
QUERY_SHAPES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "sql": (
            ...
            "       r.possessions, r.points_for, r.possessions_against, "
            "       r.offensive_rating, r.defensive_rating, r.net_rating "
            "FROM ranked r JOIN lineup l ON l.lineup_id = r.lineup_id "
